    ...
    <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <nav className="hidden items-center gap-1 text-sm font-medium text-zinc-700 md:flex">
          ...
          <Link href="/extension-tools" className="rounded-lg px-3 py-2 transition hover:bg-zinc-100 hover:text-zinc-900">
            Extension tools
          </Link>
      ...
      {mobileOpen ? (
        <div className="border-t border-zinc-200 bg-white md:hidden">
          <div className="mx-auto flex max-w-6xl flex-col gap-1 px-4 py-4 text-sm font-medium text-zinc-700 sm:px-6">
            ...
            <Link href="/extension-tools" className="rounded-lg px-3 py-2 hover:bg-zinc-50" onClick={closeMobile}>
              Extension tools
            </Link>
